object FrmClientes: TFrmClientes
  ...
  object DBGrid_Clientes: TDBGrid
    ...
    OnKeyPress = DBGrid_ClientesKeyPress
  ...
  object BitBtn1: TBitBtn
    ...
    ParentFont = False
    TabOrder = 1
    OnClick = DBGrid_ClientesDblClick
  end
      ...
      object TabSheet1: TTabSheet
        ...
        object Panel2: TPanel
          ...
          object Panel10: TPanel
            ...
            object Btn_CarregaFoto: TBitBtn
              Left = 7
              Top = 169
              Width = 109
              Height = 25
      ...
      object TabSheet2: TTabSheet
        ...
        object Panel1: TPanel
          ...
          object Label37: TLabel
            ...
            Width = 108
            Height = 13
            Caption = 'Respons'#225'vel (Contato)'
  ...
  object IBQuery_Codigo: TIBQuery
    ...
    CachedUpdates = True
    SQL.Strings = (
      'select COD_CLIE, TIPO from CLIENTES'
      'order by COD_CLIE')
    Left = 384
    Top = 40
  end
  ...
  object IBQuery_Clientes: TIBQuery
    ...
    Left = 256
    Top = 40
    object IBQuery_ClientesCOD_CLIE: TIntegerField
    ...
    object IBQuery_ClientesDATA_CADASTRO: TDateTimeField
      FieldName = 'DATA_CADASTRO'
      Origin = '"CLIENTES"."DATA_CADASTRO"'
    end
    object IBQuery_ClientesDATA_ATUALIZADO: TDateTimeField
      FieldName = 'DATA_ATUALIZADO'
      Origin = '"CLIENTES"."DATA_ATUALIZADO"'
    end
    object IBQuery_ClientesCLIENTE: TIBStringField
      DisplayLabel = 'Cliente / Empresa '
      FieldName = 'CLIENTE'
      Origin = '"CLIENTES"."CLIENTE"'
      Size = 51
    end
    object IBQuery_ClientesAPELIDO: TIBStringField
      FieldName = 'APELIDO'
      Origin = '"CLIENTES"."APELIDO"'
      Size = 25
    end
    object IBQuery_ClientesRG: TIBStringField
      DisplayLabel = 'RG / IE'
      FieldName = 'RG'
      Origin = '"CLIENTES"."RG"'
      Size = 25
    ...
    object IBQuery_ClientesIE: TIBStringField
      FieldName = 'IE'
      Origin = '"CLIENTES"."IE"'
      Size = 11
    end
    object IBQuery_ClientesDATA_NASCIMENTO: TDateTimeField
      FieldName = 'DATA_NASCIMENTO'
      Origin = '"CLIENTES"."DATA_NASCIMENTO"'
    end
    object IBQuery_ClientesPAI: TIBStringField
      FieldName = 'PAI'
      Origin = '"CLIENTES"."PAI"'
      Size = 51
    end
    object IBQuery_ClientesMAE: TIBStringField
      FieldName = 'MAE'
      Origin = '"CLIENTES"."MAE"'
      Size = 51
    end
    object IBQuery_ClientesENDERECO: TIBStringField
      FieldName = 'ENDERECO'
      Origin = '"CLIENTES"."ENDERECO"'
      Size = 50
    end
    object IBQuery_ClientesTELEFONE: TIBStringField
      DisplayLabel = 'Telefone'
      FieldName = 'TELEFONE'
      Origin = '"CLIENTES"."TELEFONE"'
    end
    object IBQuery_ClientesCIDADE: TIBStringField
      FieldName = 'CIDADE'
      Origin = '"CLIENTES"."CIDADE"'
      Size = 25
    end
    object IBQuery_ClientesBAIRRO: TIBStringField
      FieldName = 'BAIRRO'
      Origin = '"CLIENTES"."BAIRRO"'
      Size = 30
    end
    object IBQuery_ClientesCEP: TIBStringField
      FieldName = 'CEP'
      Origin = '"CLIENTES"."CEP"'
      Size = 10
    end
    object IBQuery_ClientesESTADO: TIBStringField
      FieldName = 'ESTADO'
      Origin = '"CLIENTES"."ESTADO"'
      Size = 25
    end
    object IBQuery_ClientesUF: TIBStringField
      FieldName = 'UF'
      Origin = '"CLIENTES"."UF"'
      Size = 2
    end
    object IBQuery_ClientesPONTO_REFERENCIA: TIBStringField
      FieldName = 'PONTO_REFERENCIA'
      Origin = '"CLIENTES"."PONTO_REFERENCIA"'
      Size = 50
    end
    object IBQuery_ClientesOBS: TMemoField
      FieldName = 'OBS'
      Origin = '"CLIENTES"."OBS"'
      BlobType = ftMemo
      Size = 8
    end
    object IBQuery_ClientesFOTO: TBlobField
      FieldName = 'FOTO'
      Origin = '"CLIENTES"."FOTO"'
      Size = 8
    end
    object IBQuery_ClientesNOME_EMPRESARIAL: TIBStringField
      FieldName = 'NOME_EMPRESARIAL'
      Origin = '"CLIENTES"."NOME_EMPRESARIAL"'
      Size = 116
    end
    object IBQuery_ClientesNOME_FANTASIA: TIBStringField
      FieldName = 'NOME_FANTASIA'
      Origin = '"CLIENTES"."NOME_FANTASIA"'
      Size = 56
    end
    object IBQuery_ClientesCONTATO: TIBStringField
      FieldName = 'CONTATO'
      Origin = '"CLIENTES"."CONTATO"'
      Size = 51
    end
    object IBQuery_ClientesRAMO_ATIVIDADE: TIBStringField
      FieldName = 'RAMO_ATIVIDADE'
      Origin = '"CLIENTES"."RAMO_ATIVIDADE"'
      Size = 30
    end
    object IBQuery_ClientesFAX: TIBStringField
      FieldName = 'FAX'
      Origin = '"CLIENTES"."FAX"'
    end
    object IBQuery_ClientesEMAIL: TIBStringField
      FieldName = 'EMAIL'
      Origin = '"CLIENTES"."EMAIL"'
      Size = 51
    end
    object IBQuery_ClientesNOME_USUARIO: TIBStringField
      FieldName = 'NOME_USUARIO'
      Origin = '"CLIENTES"."NOME_USUARIO"'
      Required = True
    end
    object IBQuery_ClientesTIPO: TIBStringField
      FieldName = 'TIPO'
  ...
  object DS_Botoes: TDataSource
    DataSet = Dm.IBDS_CLIENTES
    OnStateChange = DS_BotoesStateChange
    OnDataChange = DS_BotoesDataChange
    Left = 502
    Top = 40
  end
